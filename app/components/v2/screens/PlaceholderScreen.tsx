...
const SCREEN_CFG: Record<Exclude<V2Screen, "revenue-queue">, ScreenCfg> = {
  "command-center": {
...
export default function PlaceholderScreen({ screen }: { screen: Exclude<V2Screen, "revenue-queue"> }) {
...
export function PlaceholderContextPanel({
  ...
  screen: Exclude<V2Screen, "revenue-queue">;
}) {
  const cfg = SCREEN_CFG[screen];
